...
- Name: Frame1.spec.js >> Frame Handling
- Location: tests\Frame1.spec.js:3:5
...
Call log:
  - waiting for locator('//iframe[@name="employeetable"]').contentFrame().locator('//input[@id="vfb-5"]')
    - waiting for navigation to finish...
    - navigated to "https://vinothqaacademy.com/iframe/"
...
```ts
  ...
  6  |     const singleFrame = page.frameLocator('//iframe[@name="employeetable"]');
> 7  |     await singleFrame.locator('//input[@id="vfb-5"]').fill("VISHALATCHI");
     |                                                       ^ Error: locator.fill: Test timeout of 30000ms exceeded.
  8  | 
  9  | 
  10 | });
